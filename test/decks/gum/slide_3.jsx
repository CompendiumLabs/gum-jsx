...
const code = [
  [0, 'const Tile = ({ color }) =>'],
  [1, '<Box rounded padding={0.5} fill={color}>'],
  [2, '<Circle stroke={none} fill={paper} />'],
  [1, '</Box>'],
]
...
return <Slide background={paper} border={0} margin={0} padding={0.07}
  ...
  <Group aspect={2.9}>
    ...
    <T rect={[0.035, 0.07, 0.45, 0.135]} align="left" font-family={mono} color="#9bb8c5">One reusable tile</T>
    {code.map(([indent, line], i) =>
      <T rect={[0.035 + indent * 0.016, 0.25 + i * 0.12, 0.47, 0.305 + i * 0.12]} align="left" font-family={mono} color="#e8f0f3">{line}</T>
    )}
