...
<TextCol width={20} gap={0.4}>
  <TextFrame stretch scale={1.5} justify="center" rounded fill={lightgray}>A boxed heading</TextFrame>
  ...
  <TextBox width={10} justify="center" fill="#eef">a box at half width keeps its size</TextBox>
</TextCol>
